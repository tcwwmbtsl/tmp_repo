...
class YdmVerify(object):
    ...
    _token = "aJjWeNSei1TYHUB7_+swTuuRY2nxv50_XOgh6jkdmnU"
    _headers = {
    ...
    def google_verify(self, googlekey, pageurl, invisible=1, data_s=""):
        ...
        """
        url = "https://www.jfbym.com/api/YmServer/funnelApi"
        payload = json.dumps({
            "token": self._token,
            "type": "40010",  ## v2
            # "type": "40011", ## v3
        ...
        while times < 150:
            try:
                url = f"https://www.jfbym.com/api/YmServer/funnelApiResult"
                data = {
                    "token": self._token,
